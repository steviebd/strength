...
import { requireDateRange, resolveUserTimezone } from '../lib/timezone';
    ...
    const entries = await db
      ...
      .where(
        and(
          ...
          gte(schema.nutritionEntries.loggedAt, dateRange.start),
          lt(schema.nutritionEntries.loggedAt, dateRange.end),
