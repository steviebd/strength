...
const dynamicIdPrefixes = [
  ...
  'program-active-schedule-',
  'workouts-program-1rm-',
  'workout-exercise-create-muscle-',
  'workout-exercise-create-type-',
...
const requiredCoverage = [
  ...
  ['AMRAP', 'AMRAP'],
  ['weights exercise type', 'workout-exercise-create-type-weights'],
  ['bodyweight exercise type', 'workout-exercise-create-type-bodyweight'],
  ['timed exercise type', 'workout-exercise-create-type-timed'],
  ['cardio exercise type', 'workout-exercise-create-type-cardio'],
  ['plyo exercise type', 'workout-exercise-create-type-plyo'],
  ...
  ['program 1RM closeout test', 'Save 1RMs'],
